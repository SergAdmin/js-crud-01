...
router.post('/purchase-create', function (req, res) {
  ...
  if (product.amount < 1) {
    return res.render('alert', {
      ...
      data: {
        message: 'Помилка',
        info: `Такої кількості товару немає в наявності, є всього: ${product.amount} штук.`,
        link: `/purchase-product?id=${id}`,
      },
    })
  }
  ...
  // сюди виводимо назву файлу з container
  res.render('purchase-create', {
    // вказуємо назву папки container, в якій знаходяться наші стилі
...
router.post('/change', function (req, res) {
  ...
  let data = { firstname, lastname, email, phone, comment }
